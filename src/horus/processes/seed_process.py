...
def seed_processes(process_table: ProcessTable) -> None:
    ...
    process1 = process(name="init", pid=0, owner="root", cpu_mhz=8.0, mem_kb=1024, volatility=0.2, critical=True)
    process2 = process(name="bash", pid=0, owner="user1", cpu_mhz=40.0, mem_kb=2048, volatility=1.5)
